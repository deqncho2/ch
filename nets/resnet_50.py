...
net = np.load('/content/gdrive/My Drive/weights/resnet50.npy').item()
weights = {}
...
def resnet50(x):
    ...
    with tf.name_scope("conv1"):
        layers['conv1'] = conv_layer(x, weights['conv1']['weights'], weights['conv1']['biases'], s=2, relu=False)
    ...
    with tf.name_scope('fc1000'):
        layers['logit'] = fully_connected(layers['pool5_r'], weights['fc1000']['weights'], weights['fc1000']['biases'])

...
net = np.load('/content/gdrive/My Drive/weights/vgg19.npy').item()
weights = {}
biases = {}
...
def vgg19(x):
    ...
    with tf.name_scope("conv1"):
        layers['conv1_1'] = conv_layer(x, weights['conv1_1'], biases['conv1_1'])
    ...
    with tf.name_scope('fc8'):
        layers['logit'] = fully_connected(layers['fc7_d'], weights['fc8'], biases['fc8'])

...
net = np.load('/content/gdrive/My Drive/weights/googlenet.npy').item()
weights = {}
biases = {}
...
def googlenet(x):
    ...
    with tf.name_scope("conv1"):
        layers['conv1_7x7_s2'] = conv_layer(x, weights['conv1_7x7_s2'], biases['conv1_7x7_s2'],  s=2)
    ...
    with tf.name_scope('fc'):
        layers['logit'] = fully_connected(layers['pool5_7x7_s1'], weights['loss3_classifier'], biases['loss3_classifier'])
        layers['prob'] = tf.nn.softmax(layers['logit'])

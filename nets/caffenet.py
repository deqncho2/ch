...
net = np.load('/content/gdrive/My Drive/weights/caffenet.npy').item()
weights = {}
biases = {}
...
def caffenet(x):
    ...
    assert x.get_shape().as_list()[1:] == [227, 227, 3]
    layers = {}
    ...
    with tf.name_scope('fc8'):
        layers['logit'] = fully_connected(layers['fc7'], weights['fc8'], biases['fc8'])
